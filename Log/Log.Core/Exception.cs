...
#pragma warning disable S2166 // Classes named like "Exception" should extend "Exception" or a subclass
    public class Exception : IException
    {
        ...
        public Exception(
            ...
            IExceptionDataSaver dataSaver,
            IExceptionFactory exceptionFactory)
            : this(data, dataFactory, dataSaver, exceptionFactory, eventId: null)
        { }
...
#pragma warning restore S1144 // Unused private types or members should be removed
        ...
        {
            ExceptionData data = await _dataFactory.GetInnerException(new DataSettings(settings), _data);
            return data != null ? new Exception(data, _dataFactory, _dataSaver, _exceptionFactory) : null;
        }
    }
