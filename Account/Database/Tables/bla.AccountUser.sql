...
(
	...
	CONSTRAINT [PK_AccountUser] PRIMARY KEY NONCLUSTERED ([AccountGuid], [UserGuid]), 
...
CREATE CLUSTERED INDEX [IX_AccountUser_AccountGuid] ON [bla].[AccountUser] ([AccountGuid])
