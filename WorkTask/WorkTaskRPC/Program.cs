...
namespace WorkTaskRPC
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Host.ConfigureContainer((ContainerBuilder builder) => builder.RegisterModule(new WorkTakRPCModule()));
            ...
            app.MapGrpcService<WorkGroupService>();
            app.MapGrpcService<WorkTaskCommentService>();
            app.MapGrpcService<WorkTaskService>();
            app.MapGrpcService<WorkTaskStatusService>();
            app.MapGrpcService<WorkTaskTypeService>();
